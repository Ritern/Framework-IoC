...
using Assets.Ioc.extensions.pool.impl;
...
namespace Assets.Ioc.extensions.dispatcher.eventdispatcher.impl
{
    ...
    {
        // The list of clients that will be triggered as consequence of an Event firing.
        ...
        // The eventPool is shared across all EventDispatcher for efficiency.
